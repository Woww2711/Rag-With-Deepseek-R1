...
reasoner = CodeAgent(tools=[], model=reasoning_model, add_base_tools=False, max_steps=2) # max_steps is how many times the model will reason back to itself
...
def rag_with_reasoner(user_query: str) -> str:
    ...
    docs = vectordb.similarity_search(user_query, k=5) # k is number of relevant context to fetch
